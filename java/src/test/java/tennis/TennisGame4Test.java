...
public class TennisGame4Test {
	...
	@Test
	public void player2Wins3to5() {
		makeGameScore(FORTY, AD + 1);
		assertThat(game.getScore(), is("Win for player2"));
	}
	...
	@Test
	public void player2AheadAfterFortyHasAdvantage() {
	...
	public void fifteenForty() {
		makeGameScore(FIFTEEN, FORTY);
		assertThat(game.getScore(), is("Fifteen-Forty"));
	}
}
